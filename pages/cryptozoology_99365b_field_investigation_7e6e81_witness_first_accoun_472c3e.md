...
show_ads: true
description: Separate first accounts can preserve what each witness noticed before the sighting turns into a shared story.
hero_summary: Separate first accounts can preserve what each witness noticed before the sighting turns into a shared story.
layout: default
permalink: /witnesses/
...
title: Why witnesses should write before talking
title_full: Why witnesses should write before talking
display_title_short: Witnesses
display_title: Witnesses
heading_title: Why witnesses should write before talking
page_heading_title: Why witnesses should write before talking
source_count: 45
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: How to photograph a mystery track
header:
  og_image: /assets/images/cryptozoology_99365b_field_investigation_7e6e81_witness_first_accoun_472c3e-Illustration-1-social.jpg
  preview_image: /assets/images/cryptozoology_99365b_field_investigation_7e6e81_witness_first_accoun_472c3e-Illustration-1.webp
image: /assets/images/cryptozoology_99365b_field_investigation_7e6e81_witness_first_accoun_472c3e-Illustration-1-social.jpg
---
...
A first account should be recorded as soon as practical, before witnesses compare memories, photographs, theories or online reports. The goal is not to force certainty but to preserve each observer's original perception.

Useful first statements typically include:
...
Once independent statements have been collected, they can be compared systematically.

The objective is not to identify a single “correct” witness. Instead, investigators should look for patterns:
...
A witness who reports a long tail while another does not may simply have had a different viewing angle. One observer may have concentrated on movement while another focused on shape. Divergence can reveal observational limitations that help reconstruct the event more accurately.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines eyewitness reports and their limitations.</p>
        <div class="fr-book-actions">
